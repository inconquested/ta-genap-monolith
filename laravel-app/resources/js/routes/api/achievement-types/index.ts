 ...
 * @see app/Http/Controllers/AchievementTypeController.php:23
 ...
 * @see app/Http/Controllers/AchievementTypeController.php:35
 * @route '/api/achievement-types'
 */
 ...
 * @see app/Http/Controllers/AchievementTypeController.php:50
 * @route '/api/achievement-types/{achievement_type}'
 */
...
show.definition = {
    methods: ["get","head"],
    url: '/api/achievement-types/{achievement_type}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/AchievementTypeController.php:58
 * @route '/api/achievement-types/{achievement_type}'
 */
 ...
 * @see app/Http/Controllers/AchievementTypeController.php:74
 * @route '/api/achievement-types/{achievement_type}'
 */
