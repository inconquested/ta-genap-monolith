...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto focus-visible:ring-0 focus-visible:ring-offset-0 focus:outline-none", className)}>
      <ComboboxPrimitive.Input
        render={<InputGroupInput disabled={disabled} className="focus-visible:ring-0 focus-visible:ring-offset-0 focus:outline-none" />}
        {...props}
      />
