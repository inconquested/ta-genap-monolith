    ...
    return (
        <footer className="relative overflow-hidden bg-black">
            ...
            <div className="absolute inset-0">
                {/* Primary gradient - using rose-500 and orange-500 */}
                <div className="absolute inset-0 bg-gradient-to-b from-black via-rose-500/20 to-orange-500/40" />

                {/* Radial gradient blobs for depth */}
                <motion.div
                    className="absolute top-0 left-1/4 w-[800px] h-[800px] bg-rose-500/25 rounded-full blur-3xl"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 2 }}
                />
                <motion.div
                    className="absolute -bottom-1/2 right-1/4 w-[600px] h-[600px] bg-orange-500/15 rounded-full blur-3xl"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-slate-700/30 via-transparent to-slate-700/20" />
                ...
                <div className="container mx-auto px-6 md:px-8 py-20 md:py-32">
                    ...
                    >
                        ...
                        <motion.div className="lg:col-span-1 space-y-4" variants={itemVariants}>
                            ...
                            <p className="text-sm text-white/60 leading-relaxed font">
                        ...
                        <motion.div className="space-y-4" variants={itemVariants}>
                            ...
                            <ul className="space-y-3 text-sm">
                                ...
                                <li>
                                    <a href="#" className="text-white/70 hover:text-primary transition-colors duration-200 flex items-center gap-2">
                                        FAQ
                    ...
                    >
                        <motion.div className="space-y-2" variants={itemVariants}>
                            <p className="text-xs text-white/60">© 2025 Electa</p>
                            <p className="text-xs text-white/50">Made by <span className="text-primary">rynnaulia</span></p>
                        </motion.div>

                        <motion.div className="text-xs text-white/50 space-y-1" variants={itemVariants}>
